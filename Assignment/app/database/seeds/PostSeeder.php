...
class PostSeeder extends Seeder {
    public function run() {
        ...
        //Posts by Tom
        $post = new Post;
        $post->title = 'Tom\'s Post 1';
        $post->icon = 'https://upload.wikimedia.org/wikipedia/en/2/2a/Griffith_University_logo.png';
        $post->message = 'Tom\'s public post ';
        $post->post_name = 'Tom';
        $post->privacy = 'Public';
        $post->save();
        
        $post = new Post;
        $post->title = 'Tom\'s Post 2';
        $post->icon = 'https://pbs.twimg.com/profile_images/378800000003051007/01e9f11c2c487fe75f5ae6e1fd3e1d33_400x400.jpeg';
        $post->message = 'Bob\'s friends post';
        $post->post_name = 'Tom';
        $post->privacy = 'Friends';
        ...
        $post = new Post;
        $post->title = 'Tom\'s Post 3';
        $post->icon = 'https://upload.wikimedia.org/wikipedia/commons/d/d9/Big_Bear_Valley,_California.jpg';
        $post->message = 'Tom\'s private post';
        $post->post_name = 'Tom';
        $post->privacy = 'Private';
        $post->save();
        
        $post = new Post;
        $post->title = 'Tom\'s Post 4';
        $post->icon = 'https://upload.wikimedia.org/wikipedia/en/2/2a/Griffith_University_logo.png';
        $post->message = 'Tom\'s public post ';
        $post->post_name = 'Tom';
        $post->privacy = 'Public';
        ...
        $post = new Post;
        $post->title = 'Tom\'s Post 5';
        $post->icon = 'https://pbs.twimg.com/profile_images/378800000003051007/01e9f11c2c487fe75f5ae6e1fd3e1d33_400x400.jpeg';
        $post->message = 'Tom\'s friends post';
        $post->post_name = 'Tom';
        $post->privacy = 'Friends';
        $post->save();
        
        $post = new Post;
        $post->title = 'Tom\'s Post 6';
        $post->icon = 'https://upload.wikimedia.org/wikipedia/commons/d/d9/Big_Bear_Valley,_California.jpg';
        $post->message = 'Tom\'s private post';
        $post->post_name = 'Tom';
        $post->privacy = 'Private';
